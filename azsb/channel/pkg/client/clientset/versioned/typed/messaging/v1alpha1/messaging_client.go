...
import (
	...
	"knative.dev/eventing-contrib/azsb/channel/pkg/client/clientset/versioned/scheme"
)

type MessagingV1alpha1Interface interface {
	RESTClient() rest.Interface
	AZServicebusChannelsGetter
}
...
func (c *MessagingV1alpha1Client) AZServicebusChannels(namespace string) AZServicebusChannelInterface {
	return newAZServicebusChannels(c, namespace)
}
