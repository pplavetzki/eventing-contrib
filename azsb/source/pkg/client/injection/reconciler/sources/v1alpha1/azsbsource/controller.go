...
import (
	...
	versionedscheme "knative.dev/eventing-contrib/azsb/source/pkg/client/clientset/versioned/scheme"
	injectionclient "knative.dev/eventing-contrib/azsb/source/pkg/client/injection/client"
	azsbsource "knative.dev/eventing-contrib/azsb/source/pkg/client/injection/informers/sources/v1alpha1/azsbsource"
...
const (
	defaultControllerAgentName = "azsbsource-controller"
	defaultFinalizerName       = "azsbsources.sources.knative.dev"
	defaultQueueName           = "azsbsources"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	azsbsourceInformer := azsbsource.Get(ctx)
	...
	rec := &reconcilerImpl{
		...
		Lister:     azsbsourceInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
