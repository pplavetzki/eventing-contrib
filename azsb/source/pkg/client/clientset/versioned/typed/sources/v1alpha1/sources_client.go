...
import (
	...
	"knative.dev/eventing-contrib/azsb/source/pkg/client/clientset/versioned/scheme"
)
...
func (c *SourcesV1alpha1Client) AzsbSources(namespace string) AzsbSourceInterface {
	return newAzsbSources(c, namespace)
}
